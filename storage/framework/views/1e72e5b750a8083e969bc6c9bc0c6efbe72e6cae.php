<?php $__env->startSection('title', 'Stok Opname Triwulan - Aplikasi Inventaris'); ?>

<?php $__env->startSection('page_title', 'Stok Opname Triwulan'); ?>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="quarter-selector">
                            <?php $__currentLoopData = $quarters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $q => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('quarterly-stock.index', ['tahun' => $selectedTahun, 'quarter' => $q])); ?>" 
                                   class="quarter-btn <?php echo e($selectedQuarter == $q ? 'active' : ''); ?>">
                                    <?php echo e($q); ?>
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            <span class="text-white" style="font-size: 0.875rem; font-weight: 600;">
                                <i class="fas fa-calendar-alt me-2"></i><?php echo e($periodLabel); ?>

                            </span>
                            <?php if($actualStart && $actualEnd): ?>
                            <div class="period-label mt-1">
                                <i class="fas fa-info-circle me-1"></i>
                                Data transaksi: <?php echo e(Carbon\Carbon::parse($actualStart)->format('d/m/Y')); ?> - <?php echo e(Carbon\Carbon::parse($actualEnd)->format('d/m/Y')); ?>
                        ...
                        <div>
                            <button type="button" class="btn btn-light btn-sm" data-bs-toggle="modal" data-bs-target="#exportModal" <?php if(!$actualStart || !$actualEnd): ?> disabled <?php endif; ?>>
        ...
        <div class="stat-box stat-total">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <div style="font-size: 1.5rem; font-weight: 700;"><?php echo e($barangData->count()); ?></div>
                </div>
        ...
        <div class="stat-box stat-positive">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <div style="font-size: 1.5rem; font-weight: 700;"><?php echo e($barangData->where('stok_opname', '>', 0)->count()); ?></div>
                </div>
        ...
        <div class="card quarter-card">
            <div class="card-header bg-white py-3" style="border-bottom: 1px solid #e2e8f0;">
                <h5 class="mb-0" style="font-size: 0.9375rem; font-weight: 600;">
                    ...
                    Data Stok Opname - <?php echo e($selectedQuarter); ?> <?php echo e($selectedTahun); ?>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <?php
                                $no = 1;
                            ?>
                            <?php $__currentLoopData = $barangData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($item->stok_opname > 0): ?>
                                <tr>
                                    <td class="text-center"><?php echo e($no++); ?></td>
                                    <td><?php echo e($item->nama_barang); ?></td>
                                    <td class="text-center"><?php echo e($item->satuan); ?></td>
                                    <td class="text-center">
                                        <span style="font-weight: 600;"><?php echo e(number_format($item->stok_opname)); ?></span>
                                    </td>
                                </tr>
                                <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php if($barangData->where('stok_opname', '>', 0)->isEmpty()): ?>
                                <tr>
...
<div class="modal fade" id="exportModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="<?php echo e(route('quarterly-stock.export')); ?>" method="POST" id="exportForm">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="tahun" value="<?php echo e($selectedTahun); ?>">
                ...
                <div class="modal-body">
                    <div class="alert" style="background: #e0f2fe; color: #0369a1; border-radius: 8px; padding: 12px; margin-bottom: 16px;">
                        ...
                        <strong>Periode:</strong> <?php echo e($periodLabel); ?>
...
<script>
    document.getElementById('filterTahun').addEventListener('change', function() {
        ...
        const quarter = '<?php echo e($selectedQuarter); ?>';
        window.location.href = '<?php echo e(route('quarterly-stock.index')); ?>?tahun=' + tahun + '&quarter=' + quarter;
    });
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\inventaris-barang2\inventaris-kantor\resources\views/quarterly-stock/index.blade.php ENDPATH**/ ?>