<?php $__env->startSection('title', 'Data Barang - Aplikasi Inventaris'); ?>
<?php $__env->startSection('page_title', 'Data Barang'); ?>
...
<div class="d-flex justify-content-between align-items-center mb-4 animate-fade-up">
    ...
    <div class="page-actions">
        <a href="<?php echo e(route('barang.export', request()->all())); ?>" class="btn btn-success">
        ...
        <div class="card animate-fade-up animate-delay-1" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
            <div class="card-body p-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <div style="font-size: 1.5rem; font-weight: 700;"><?php echo e($barangs->total()); ?></div>
            ...
            <div class="card-body p-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        ?>
                        <div style="font-size: 1.5rem; font-weight: 700;"><?php echo e($stokTersedia); ?></div>
            ...
            <div class="card-body p-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        ?>
                        <div style="font-size: 1.5rem; font-weight: 700;"><?php echo e($stokRendah); ?></div>
...
<div class="filter-card animate-fade-up animate-delay-4">
    <form method="GET" action="<?php echo e(route('barang.index')); ?>" class="row g-3">
        <div class="col-md-4">
            ...
            <div class="input-group">
                ...
                <input type="text" name="search" class="form-control" placeholder="Nama barang..." value="<?php echo e(request('search')); ?>" style="border-radius: 0 10px 10px 0;">
            </div>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            ...
            <select name="status" class="form-select" style="border-radius: 10px;">
                ...
                <option value="rendah" <?php echo e(request('status') == 'rendah' ? 'selected' : ''); ?>>Stok Rendah</option>
                <option value="habis" <?php echo e(request('status') == 'habis' ? 'selected' : ''); ?>>Stok Habis</option>
            </select>
        </div>
        <div class="col-md-2">
...
<div id="bulkToolbar" class="bulk-toolbar" style="display: none;">
    <form id="bulkDeleteForm" action="<?php echo e(route('barang.bulkDelete')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
<div class="data-card animate-fade-up animate-delay-5">
        ...
        <table class="table table-hover mb-0">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $barangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $barang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <input type="checkbox" class="bulk-checkbox form-check-input" value="<?php echo e($barang->id); ?>">
                        </td>
                        <?php endif; ?>
                        <td>
                            <div class="fw-semibold"><?php echo e($barang->nama_barang); ?></div>
                            <?php if($barang->catatan): ?>
                            <small class="text-muted"><?php echo e(Str::limit($barang->catatan, 40)); ?></small>
                            <?php endif; ?>
                        </td>
                        <td><span class="badge bg-secondary"><?php echo e($barang->kategori); ?></span></td>
                        <td><?php echo e($barang->satuan); ?></td>
                        <td class="text-center">
                            <div class="editable-stok-wrapper" data-barang-id="<?php echo e($barang->id); ?>" data-stok-lama="<?php echo e($barang->stok); ?>" data-stok-minimum="<?php echo e($barang->stok_minimum); ?>" data-nama-barang="<?php echo e($barang->nama_barang); ?>">
                                <span class="btn btn-link fw-bold stok-display" style="font-size: 1rem; text-decoration: none; cursor: pointer; color: inherit;" title="Klik untuk edit stok">
                                    <?php echo e(number_format($barang->stok)); ?>
                                ...
                                <div class="stok-edit-form" style="display: none;">
                                    <div class="input-group" style="max-width: 160px; margin: 0 auto;">
                                        <input type="number" class="form-control form-control-sm stok-input" value="<?php echo e($barang->stok); ?>" min="0" style="text-align: center;">
                        ...
                        <td>
                            ...
                            <?php elseif($barang->stok <= $barang->stok_minimum): ?>
                        ...
                        <td class="text-center">
                            <div class="btn-group" role="group">
                                <a href="<?php echo e(route('barang.show', $barang->id)); ?>" class="btn btn-sm btn-info action-btn" title="Lihat">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <?php if(Auth::user()->isAdmin()): ?>
                                <a href="<?php echo e(route('barang.edit', $barang->id)); ?>" class="btn btn-sm btn-warning action-btn" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="<?php echo e(route('barang.destroy', $barang->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Yakin hapus barang ini?')">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
                        <td colspan="<?php echo e(Auth::user()->isAdmin() ? '8' : '7'); ?>" class="text-center py-5">
                            ...
                            <a href="<?php echo e(route('barang.create')); ?>" class="btn btn-primary btn-sm mt-2">
    ...
    <div class="p-3 bg-light border-top d-flex justify-content-between align-items-center flex-wrap gap-2">
        <div class="text-muted" style="font-size: 0.8125rem;">
            Menampilkan <strong><?php echo e($barangs->firstItem() ?? 0); ?></strong> - <strong><?php echo e($barangs->lastItem() ?? 0); ?></strong> dari <strong><?php echo e($barangs->total()); ?></strong> data
        </div>
        <nav>
            <?php echo e($barangs->links('pagination.slim')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\inventaris-barang2\inventaris-kantor\resources\views/barang/index.blade.php ENDPATH**/ ?>