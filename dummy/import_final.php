...
/**
 * CORRECTED DUMMY DATA IMPORT
 * Menggunakan foreign key yang valid
 */
...
echo "\n";
echo "╔══════════════════════════════════════════════════════════╗\n";
echo "║     IMPORT DUMMY DATA (Foreign Key Valid)              ║\n";
echo "╚══════════════════════════════════════════════════════════╝\n";
echo "\n";

// Data dummy yang valid dengan FK yang ada di DB
$dummyData = [
    // Januari 2026
    ['barang_id' => 1, 'tipe' => 'masuk', 'jumlah_masuk' => 50, 'jumlah_keluar' => 0, 'jumlah' => 50, 'stok_sebelum' => 0, 'stok_setelah_masuk' => 50, 'sisa_stok' => 50, 'tanggal' => '2026-01-05', 'ruangan_id' => 11, 'user_id' => 1, 'nama_pengambil' => null, 'tipe_pengambil' => null, 'tanggal_keluar' => null, 'keterangan' => 'Stok awal - Kertas A4', 'created_at' => '2026-01-05 08:00:00', 'updated_at' => '2026-01-05 08:00:00'],
    ['barang_id' => 2, 'tipe' => 'masuk', 'jumlah_masuk' => 30, 'jumlah_keluar' => 0, 'jumlah' => 30, 'stok_sebelum' => 0, 'stok_setelah_masuk' => 30, 'sisa_stok' => 30, 'tanggal' => '2026-01-05', 'ruangan_id' => 11, 'user_id' => 1, 'nama_pengambil' => null, 'tipe_pengambil' => null, 'tanggal_keluar' => null, 'keterangan' => 'Stok awal - Kertas A4 70gr', 'created_at' => '2026-01-05 08:00:00', 'updated_at' => '2026-01-05 08:00:00'],
    ['barang_id' => 3, 'tipe' => 'masuk', 'jumlah_masuk' => 20, 'jumlah_keluar' => 0, 'jumlah' => 20, 'stok_sebelum' => 0, 'stok_setelah_masuk' => 20, 'sisa_stok' => 20, 'tanggal' => '2026-01-08', 'ruangan_id' => 11, 'user_id' => 1, 'nama_pengambil' => null, 'tipe_pengambil' => null, 'tanggal_keluar' => null, 'keterangan' => 'Pembelian tinta', 'created_at' => '2026-01-08 09:30:00', 'updated_at' => '2026-01-08 09:30:00'],
    ['barang_id' => 7, 'tipe' => 'masuk', 'jumlah_masuk' => 100, 'jumlah_keluar' => 0, 'jumlah' => 100, 'stok_sebelum' => 0, 'stok_setelah_masuk' => 100, 'sisa_stok' => 100, 'tanggal' => '2026-01-10', 'ruangan_id' => 11, 'user_id' => 1, 'nama_pengambil' => null, 'tipe_pengambil' => null, 'tanggal_keluar' => null, 'keterangan' => 'Stok bolpoin', 'created_at' => '2026-01-10 10:00:00', 'updated_at' => '2026-01-10 10:00:00'],
    ['barang_id' => 14, 'tipe' => 'masuk', 'jumlah_masuk' => 200, 'jumlah_keluar' => 0, 'jumlah' => 200, 'stok_sebelum' => 0, 'stok_setelah_masuk' => 200, 'sisa_stok' => 200, 'tanggal' => '2026-01-12', 'ruangan_id' => 11, 'user_id' => 1, 'nama_pengambil' => null, 'tipe_pengambil' => null, 'tanggal_keluar' => null, 'keterangan' => 'Stok map folder', 'created_at' => '2026-01-12 11:00:00', 'updated_at' => '2026-01-12 11:00:00'],
    ['barang_id' => 1, 'tipe' => 'keluar', 'jumlah_masuk' => 0, 'jumlah_keluar' => 5, 'jumlah' => 5, 'stok_sebelum' => 50, 'stok_setelah_masuk' => 50, 'sisa_stok' => 45, 'tanggal' => '2026-01-15', 'ruangan_id' => 12, 'user_id' => 1, 'nama_pengambil' => 'Budi Santoso', 'tipe_pengambil' => 'internal', 'tanggal_keluar' => '2026-01-15', 'keterangan' => 'Penggunaan rutin', 'created_at' => '2026-01-15 13:00:00', 'updated_at' => '2026-01-15 13:00:00'],
    ['barang_id' => 1, 'tipe' => 'keluar', 'jumlah_masuk' => 0, 'jumlah_keluar' => 3, 'jumlah' => 3, 'stok_sebelum' => 45, 'stok_setelah_masuk' => 45, 'sisa_stok' => 42, 'tanggal' => '2026-01-18', 'ruangan_id' => 12, 'user_id' => 1, 'nama_pengambil' => 'Dewi Kusuma', 'tipe_pengambil' => 'internal', 'tanggal_keluar' => '2026-01-18', 'keterangan' => 'Keperluan UKBI', 'created_at' => '2026-01-18 14:00:00', 'updated_at' => '2026-01-18 14:00:00'],
    ['barang_id' => 7, 'tipe' => 'keluar', 'jumlah_masuk' => 0, 'jumlah_keluar' => 10, 'jumlah' => 10, 'stok_sebelum' => 100, 'stok_setelah_masuk' => 100, 'sisa_stok' => 90, 'tanggal' => '2026-01-20', 'ruangan_id' => 12, 'user_id' => 1, 'nama_pengambil' => 'Ahmad Hidayat', 'tipe_pengambil' => 'internal', 'tanggal_keluar' => '2026-01-20', 'keterangan' => 'Peminjaman', 'created_at' => '2026-01-20 08:00:00', 'updated_at' => '2026-01-20 08:00:00'],
    
    // Februari 2026
    ['barang_id' => 4, 'tipe' => 'masuk', 'jumlah_masuk' => 15, 'jumlah_keluar' => 0, 'jumlah' => 15, 'stok_sebelum' => 0, 'stok_setelah_masuk' => 15, 'sisa_stok' => 15, 'tanggal' => '2026-02-03', 'ruangan_id' => 11, 'user_id' => 1, 'nama_pengambil' => null, 'tipe_pengambil' => null, 'tanggal_keluar' => null, 'keterangan' => 'Restock tinta', 'created_at' => '2026-02-03 08:00:00', 'updated_at' => '2026-02-03 08:00:00'],
    ['barang_id' => 8, 'tipe' => 'masuk', 'jumlah_masuk' => 80, 'jumlah_keluar' => 0, 'jumlah' => 80, 'stok_sebelum' => 0, 'stok_setelah_masuk' => 80, 'sisa_stok' => 80, 'tanggal' => '2026-02-05', 'ruangan_id' => 11, 'user_id' => 1, 'nama_pengambil' => null, 'tipe_pengambil' => null, 'tanggal_keluar' => null, 'keterangan' => 'Stok bolpoin biru', 'created_at' => '2026-02-05 09:00:00', 'updated_at' => '2026-02-05 09:00:00'],
    ['barang_id' => 9, 'tipe' => 'masuk', 'jumlah_masuk' => 60, 'jumlah_keluar' => 0, 'jumlah' => 60, 'stok_sebelum' => 0, 'stok_setelah_masuk' => 60, 'sisa_stok' => 60, 'tanggal' => '2026-02-08', 'ruangan_id' => 11, 'user_id' => 1, 'nama_pengambil' => null, 'tipe_pengambil' => null, 'tanggal_keluar' => null, 'keterangan' => 'Stok pensil', 'created_at' => '2026-02-08 10:00:00', 'updated_at' => '2026-02-08 10:00:00'],
    ['barang_id' => 1, 'tipe' => 'keluar', 'jumlah_masuk' => 0, 'jumlah_keluar' => 8, 'jumlah' => 8, 'stok_sebelum' => 42, 'stok_setelah_masuk' => 42, 'sisa_stok' => 34, 'tanggal' => '2026-02-10', 'ruangan_id' => 12, 'user_id' => 1, 'nama_pengambil' => 'Siti Rahayu', 'tipe_pengambil' => 'internal', 'tanggal_keluar' => '2026-02-10', 'keterangan' => 'Rapat bulanan', 'created_at' => '2026-02-10 11:00:00', 'updated_at' => '2026-02-10 11:00:00'],
    ...
    ['barang_id' => 7, 'tipe' => 'keluar', 'jumlah_masuk' => 0, 'jumlah_keluar' => 15, 'jumlah' => 15, 'stok_sebelum' => 63, 'stok_setelah_masuk' => 63, 'sisa_stok' => 48, 'tanggal' => '2026-05-15', 'ruangan_id' => 11, 'user_id' => 1, 'nama_pengambil' => 'Rudi Hartono', 'tipe_pengambil' => 'internal', 'tanggal_keluar' => '2026-05-15', 'keterangan' => 'Cetak massal', 'created_at' => '2026-05-15 13:00:00', 'updated_at' => '2026-05-15 13:00:00'],
    
    // Juni 2026
    ['barang_id' => 18, 'tipe' => 'masuk', 'jumlah_masuk' => 8, 'jumlah_keluar' => 0, 'jumlah' => 8, 'stok_sebelum' => 0, 'stok_setelah_masuk' => 8, 'sisa_stok' => 8, 'tanggal' => '2026-06-02', 'ruangan_id' => 11, 'user_id' => 1, 'nama_pengambil' => null, 'tipe_pengambil' => null, 'tanggal_keluar' => null, 'keterangan' => 'Stok gunting', 'created_at' => '2026-06-02 08:00:00', 'updated_at' => '2026-06-02 08:00:00'],
    ['barang_id' => 19, 'tipe' => 'masuk', 'jumlah_masuk' => 12, 'jumlah_keluar' => 0, 'jumlah' => 12, 'stok_sebelum' => 0, 'stok_setelah_masuk' => 12, 'sisa_stok' => 12, 'tanggal' => '2026-06-05', 'ruangan_id' => 11, 'user_id' => 1, 'nama_pengambil' => null, 'tipe_pengambil' => null, 'tanggal_keluar' => null, 'keterangan' => 'Stok gunting kecil', 'created_at' => '2026-06-05 09:00:00', 'updated_at' => '2026-06-05 09:00:00'],
    ['barang_id' => 20, 'tipe' => 'masuk', 'jumlah_masuk' => 10, 'jumlah_keluar' => 0, 'jumlah' => 10, 'stok_sebelum' => 0, 'stok_setelah_masuk' => 10, 'sisa_stok' => 10, 'tanggal' => '2026-06-08', 'ruangan_id' => 11, 'user_id' => 1, 'nama_pengambil' => null, 'tipe_pengambil' => null, 'tanggal_keluar' => null, 'keterangan' => 'Stok kalkulator', 'created_at' => '2026-06-08 10:00:00', 'updated_at' => '2026-06-08 10:00:00'],
    ...
    ['barang_id' => 10, 'tipe' => 'keluar', 'jumlah_masuk' => 0, 'jumlah_keluar' => 6, 'jumlah' => 6, 'stok_sebelum' => 40, 'stok_setelah_masuk' => 40, 'sisa_stok' => 34, 'tanggal' => '2026-07-15', 'ruangan_id' => 12, 'user_id' => 1, 'nama_pengambil' => 'Siti Rahayu', 'tipe_pengambil' => 'internal', 'tanggal_keluar' => '2026-07-15', 'keterangan' => 'Keperluan alih daya', 'created_at' => '2026-07-15 13:00:00', 'updated_at' => '2026-07-15 13:00:00'],
];
...
echo "📊 Inserting " . count($dummyData) . " dummy transactions with valid foreign keys...\n\n";
...
foreach ($dummyData as $index => $data) {
    try {
        ...
        $errorCount++;
        echo "⚠️  Error on record " . ($index + 1) . ": " . substr($e->getMessage(), 0, 60) . "\n";
    }
}

echo "✅ Progress: " . count($dummyData) . "/" . count($dummyData) . " processed\n\n";
