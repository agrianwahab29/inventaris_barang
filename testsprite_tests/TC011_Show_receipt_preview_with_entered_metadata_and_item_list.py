...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'UNIQUE_NOMOR_12345') and contains(., 'Sample Item Name')]").nth(0).is_visible(), "The preview should display the entered nomor surat and at least one item from the barang list."
