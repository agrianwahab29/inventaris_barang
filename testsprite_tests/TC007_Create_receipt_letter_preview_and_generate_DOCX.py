...
async def run_test():
    ...
    try:
        ...
        # -> Fill the username and password fields and submit the login form to authenticate as admin.
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'surat_tanda_terima.docx')]").nth(0).is_visible(), "The DOCX receipt file link should be visible after document generation."
