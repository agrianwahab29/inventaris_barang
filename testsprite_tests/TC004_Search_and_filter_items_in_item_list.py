...
async def run_test():
    ...
    try:
        ...
        # -> Log in using the admin credentials (admin / admin123) by filling the username and password fields and submitting the form.
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Item List')]").nth(0).is_visible(), "The item list should display matching results after applying the search and category filter"
